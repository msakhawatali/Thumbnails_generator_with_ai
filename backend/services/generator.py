...
STYLES = {
    "bold_dramatic": (
        ...
        "cinematic lighting, dark mooody background, and powerful compsition."
    ...
    "clean_minimal": (
        ...
        "white/light background, models professional aesthetic, plenty of "
    ...
    "vibrant_energetic": (
        ...
        "dynamic angles, eye-catching pop_art style colors, and energetic "
...
async def process_job(job_id: str):
    ...
    # find all thumbnail for this job 
